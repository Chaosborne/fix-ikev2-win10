...
- **Test-4-Renew-IP.bat** - renew IP addresses
...
### How to use:
1. When VPN "breaks" again, run test files **one by one**
2. After each file try to connect to VPN
3. Remember which file helped
4. Report result to create minimal file
